...
my_file = open("2-obj-detection-model\VisDone.txt", "r")
# reading the file
data = my_file.read()
...
model_path = '2-obj-detection-model\\result\\10_epochs_12\weights\\best.pt'
# model_path = '2-obj-detection-model\\result\\10_epochs_12\weights\\best.pt'
model = YOLO(model_path)


# cap = cv2.VideoCapture(1)
cap = cv2.VideoCapture("DSVIDEO-drone/3-cyclist-and-vehicle-tracking-1.mp4")
...
out = cv2.VideoWriter('filename_old.avi', cv2.VideoWriter_fourcc(*'MJPG'), 10, dimension) 
